...
namespace Tests\Feature\UI\Gifts\Concerns;
...
trait CreatesGiftsUiContext
{
    ...
    private function createCoupleWithPartner(User $owner): array
    {
        ...
        $couple = Couple::query()->create([
            'name' => 'Gifts UI Couple',
            'invite_code' => 'GUI'.str_pad((string) random_int(1, 9999), 4, '0', STR_PAD_LEFT),
