...
class MissionsUiPageTest extends TestCase
{
    ...
    public function test_user_with_current_couple_can_view_missions_ui(): void
    {
        ...
        $this->actingAs($user)
            ...
            ->assertSee('Assigned Missions');
    }

    public function test_user_with_no_current_couple_sees_no_couple_message(): void
    {
        $user = User::factory()->create();
