...
<body class="bg-navy h-screen overflow-hidden">
    ...
    <main class="relative h-full w-full flex items-center justify-center">
        ...
        <div class="absolute bottom-0 w-full h-48 bg-leaf border-t-8 border-[#3d8c4d]">
            ...
            <div class="grid grid-cols-4 h-full max-w-4xl mx-auto gap-4 p-8">
                <div class="border-2 border-dashed border-white/20 rounded-lg hover:bg-white/10 transition-colors cursor-pointer flex items-center justify-center text-white/20 font-pixel text-4xl">+</div>
    ...
    <nav class="fixed bottom-0 left-0 right-0 p-4">
        <div class="max-w-md mx-auto bg-parchment border-4 border-toast flex justify-around p-2 shadow-[0_-6px_0_rgba(0,0,0,0.2)]">
